package com.example.tdm2_td02_exo2.ui.requestPermission
...
class RequestPermissionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_request_permession)
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(
                    this,
                    "Permission must be granted to display contacts ",
                    Toast.LENGTH_SHORT
                ).show()
